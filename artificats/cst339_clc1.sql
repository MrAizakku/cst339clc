...
INSERT INTO `categories` VALUES (1,'Unspecified');
...
CREATE TABLE `posts` (
  ...
  CONSTRAINT `posts_ibfk_1` FOREIGN KEY (`POST_AUTHOR`) REFERENCES `users` (`USER_ID`) ON DELETE CASCADE,
  CONSTRAINT `posts_ibfk_2` FOREIGN KEY (`POST_UPDATED_BY`) REFERENCES `users` (`USER_ID`) ON DELETE CASCADE,
  CONSTRAINT `posts_ibfk_3` FOREIGN KEY (`CATEGORY_ID`) REFERENCES `categories` (`CATEGORY_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2021-08-08 12:46:52
